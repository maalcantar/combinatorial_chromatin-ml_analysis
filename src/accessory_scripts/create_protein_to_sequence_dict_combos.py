...
"""
Created on February 1 17:48:30 2023
@author: alcantar
example usage: python create_protein_to_sequence_dict_combos.py
"""
...
def main():
    ...
    for protein_name_1 in protein_name_to_aa_dict:
        for protein_name_2 in protein_name_to_aa_dict:
            ...
            combo_seq = protein_name_to_aa_dict[protein_name_1] + protein_name_to_aa_dict[protein_name_2]
    ...
    # define output paths
    pickle_output_path ='../../data/combicr_protein_to_aa_sequence_combos_dict.pkl'
    pickle_output_scrambled_path ='../../data/combicr_protein_to_aa_sequence_combos_scrambled_dict.pkl'
