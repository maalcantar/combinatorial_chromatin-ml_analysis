...
"""
Created on November 12 15:28:24 2023
@author: alcantar
example run 1: python 03a_process_flow_seq.py -i ../../combicr_data/combicr_outputs/maa-005/pickle_files/combiCR_results.pkl -m ../../combicr_data/Quintata_NGS_raw/MAA_005/AVITI_2023-10-23/Fastq/MAA_005_metadata.txt -r pMAA166 pMAA167 -t 100 -b 8
"""
...
def flow_seq_data_processing(reporter_id,
    ...
    pMAA06_166_rep1_cell_counts = [800000,800000,800000,800000,
                                   800000,696821, 223283,356394]
    pMAA06_166_rep2_cell_counts = [800000,800000,800000,800000,
                                  800000,800000, 303537,402968]

    pMAA06_167_rep1_cell_counts = [800000, 800000, 800000, 800000,
                                   800000, 800000, 445520, 394552]
    pMAA06_167_rep2_cell_counts = [800000, 800000, 800000, 800000,
                                   800000, 800000, 451326, 372694]
    # fraction of cells from each sorting bin (per replicate)
    pMAA06_166_rep1_cell_fracs = [cell_count_bin/sum(pMAA06_166_rep1_cell_counts) for cell_count_bin in pMAA06_166_rep1_cell_counts]
    pMAA06_166_rep2_cell_fracs = [cell_count_bin/sum(pMAA06_166_rep2_cell_counts) for cell_count_bin in pMAA06_166_rep2_cell_counts]
    pMAA06_167_rep1_cell_fracs = [cell_count_bin/sum(pMAA06_167_rep1_cell_counts) for cell_count_bin in pMAA06_167_rep1_cell_counts]
    pMAA06_167_rep2_cell_fracs = [cell_count_bin/sum(pMAA06_167_rep2_cell_counts) for cell_count_bin in pMAA06_167_rep2_cell_counts]

    # sequencing counts for each bin
    pMAA06_166_rep1_seq_counts = [1867914, 2830111, 2291693, 2454395,
                                  2240674, 1923659, 1499260, 1332468]
    pMAA06_166_rep2_seq_counts = [1769843, 1349375, 1486107, 2545853,
                                  1900979, 2577915, 1953838, 1947699]
    pMAA06_167_rep1_seq_counts = [2041429, 1773543, 2261707, 1848460,
                                  1730890, 1809454, 1852945, 2666558]
    pMAA06_167_rep2_seq_counts = [2092418, 2205777, 1812938, 1493325,
                                  2296661, 2284290, 1970966, 2136483]
    # dictionaries with cell fraction and read count information
    cell_fracs_dict = {'pMAA166_rep_1': pMAA06_166_rep1_cell_fracs,
                        'pMAA166_rep_2': pMAA06_166_rep2_cell_fracs,
                        'pMAA167_rep_1': pMAA06_167_rep1_cell_fracs,
                        'pMAA167_rep_2': pMAA06_167_rep2_cell_fracs}
    counts_dict = {'pMAA166_rep_1': pMAA06_166_rep1_seq_counts,
                        'pMAA166_rep_2': pMAA06_166_rep2_seq_counts,
                        'pMAA167_rep_1': pMAA06_167_rep1_seq_counts,
                        'pMAA167_rep_2': pMAA06_167_rep2_seq_counts}
